...
/**
 `MEDownloadTask` component used to hold download data, `MEDownloader` only create 1 task for each URL On Completion whether with fail or success, `MEDownloadTask` notifies `MEDownloadRequest`s with result
 */
